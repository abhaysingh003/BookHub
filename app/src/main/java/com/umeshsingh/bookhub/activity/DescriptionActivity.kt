            ...
            val jsonRequest =
                object : JsonObjectRequest(Request.Method.POST, url, jsonParams, Response.Listener {
                    ...
                    try {
                        ...
                        if (success) {
                            println("Success if condition inside try block")
                            ...
                            btnAddToFav.setOnClickListener {
                                //adding to favourite list first book
                                //it only add book at 0 index and it is not persistent
                                FavouritesFragment.dbBookList.add(DashboardFragment.bookInfoList[0])
